...
const PILLARS_DATA: PillarItem[] = [
  {
    ...
    subheadline: "Real-time safeguards that keep inventory accurate during peak sales",
    summary:
      "When team members or order channels update items at the same time, Inventry safely processes each update in order. Stock deductions happen cleanly so your available inventory never drops below zero.",
    ...
    metrics: [
      ...
      { label: "Order Protection", value: "Instant Guard" },
      { label: "Stock Accuracy", value: "99.9%" },
    ],
    systemGuarantees: [
      { label: "STOCK ACCURACY", value: "100% Guaranteed", highlight: true },
      { label: "SAFEGUARD PROTOCOL", value: "Continuous Check" },
      { label: "OVERSELLING", value: "Prevented" },
    ],
    details: [
      "Automatic order queuing ensures items are claimed one by one without overselling.",
      "Outbound movements validate available stock before saving, preventing negative balances.",
      "Every stock movement records the team member, timestamp, quantity, and optional notes.",
      "Instant stock status badges flag items as OK, Low Stock, or Out of Stock across your catalog.",
    ],
  },
  {
    id: "reordering",
  ...
  },
  {
    ...
    subheadline: "Private company workspaces with encrypted account security",
    summary:
      "Every company's data is kept strictly private and separated. Administrators have full control over company settings and team invites, while staff members can record stock additions and dispatches with full accountability.",
    badge: "Private Workspaces",
    image: networkNodes,
    imageAlt:
      "Secure modular workspaces and protected company account boundaries",
    imageCaption: "Company Security: 100% Private Workspaces",
    icon: ShieldCheckIcon,
    metrics: [
      { label: "Company Privacy", value: "100% Isolated" },
      { label: "Role Permissions", value: "Admin & Staff" },
      { label: "Account Security", value: "Encrypted Sessions" },
    ],
    systemGuarantees: [
      { label: "DATA PRIVACY", value: "Workspace-Protected", highlight: true },
      { label: "ACCESS CONTROL", value: "Role-Restricted" },
      { label: "LOGIN PROTECTION", value: "Encrypted Cookies" },
    ],
    details: [
      "Strict data privacy safeguards ensure organizations never see or access each other's items.",
      ...
      "Bank-grade security and encrypted credentials keep company accounts safe at all times.",
    ],
  },
];
