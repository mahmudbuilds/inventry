          ...
          <div className="space-y-1.5 text-left">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={cn(
                  "w-full pl-10 pr-10 py-2.5 bg-zinc-50/50 hover:bg-zinc-50 focus:bg-white border rounded-xl text-sm text-zinc-900 placeholder:text-zinc-400 transition-all focus:outline-none focus:ring-3",
                  passwordsMismatch
